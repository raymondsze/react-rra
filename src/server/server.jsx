...
import HTMLMarkup from '~/server/components/HTMLMarkup';
...
const assetsFilePath = path.join(process.cwd(), 'build/webpack-assets.json');
...
clientBuilt((assets) => {
  ...
  if (!__DEVELOPMENT__ && process.env.HTTPS === 'true') {
  ...
  server.use('/public', express.static(path.join(__dirname, '../build/client'), { maxAge: '30d' }));
